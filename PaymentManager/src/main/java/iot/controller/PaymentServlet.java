...
public class PaymentServlet extends HttpServlet {
     protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { 
        ...
        try{
            LinkedList<Order> submitOrders = manager.findSubmitOrderList(email);
            session.setAttribute("submitOrders",submitOrders);
            request.getRequestDispatcher("PaymentOperation.jsp").include(request, response);
